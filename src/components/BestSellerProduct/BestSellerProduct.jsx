...
const BestSellerProduct = () => {
    ...
    const nextSlide = () => {
        setCurrentIndex((prevIndex) =>
            prevIndex + itemsPerPage < products.length ? prevIndex + itemsPerPage - 3 : 0
        );
    };
    const prevSlide = () => {
        setCurrentIndex((prevIndex) => {
    ...
    return (
        <div className='my-10'>
        <h1 className='border-y-2 border-[#2B3467] border-dashed text-[#2B3467] text-center text-3xl font-semibold w-96 p-2 mx-auto '>Best Seller Products</h1>
