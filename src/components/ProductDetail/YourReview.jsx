    ...
    return (
        <div className='bg-white p-5'>
            ...
            <div className='mb-5 bg-gray-100 p-5'>
                    ...
                    <input className=' w-full md:w-1/2 p-3 border-2 focus:outline-none' placeholder='Your Name' type="text" />
                </div>
            <div className='bg-gray-100 p-5'>
                    <p className='font-bold text-[#2B3467] mb-3 flex items-center gap-1'>Review <FaPen></FaPen></p>
                    <textarea className=' w-full md:w-1/2 p-3 border-2 focus:outline-none' placeholder='Your Review' type="text" />
                </div>
